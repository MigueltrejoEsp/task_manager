import Config
config :task_manager, token_signing_secret: "qS31yFXV80TSKzzyyHAmx0KEXvqTKUdz"
...
config :task_manager, TaskManagerWeb.Endpoint,
  ...
  secret_key_base: "XhgT2pkgs67m82r333gbobdCBvX2hzBINoFTgAKBVHrXAbpoKMzV5+cU1hey9TQv",
  server: false
